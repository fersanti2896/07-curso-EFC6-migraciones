...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PeliculasWebAPI.Entidades.CineOferta", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaFin = new DateTime(2022, 5, 17, 0, 0, 0, 0, DateTimeKind.Local),
                            FechaInicio = new DateTime(2022, 5, 12, 0, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            Id = 1,
                            ...
                            FechaFin = new DateTime(2022, 5, 19, 0, 0, 0, 0, DateTimeKind.Local),
                            FechaInicio = new DateTime(2022, 5, 12, 0, 0, 0, 0, DateTimeKind.Local)
                        });
                });
            ...
            modelBuilder.Entity("PeliculasWebAPI.Entidades.Mensaje", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PeliculasWebAPI.Entidades.Pelicula", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 5,
                            Cartelera = true,
                            FechaEstreno = new DateTime(2022, 5, 12, 0, 0, 0, 0, DateTimeKind.Local),
            ...
            modelBuilder.Entity("PeliculasWebAPI.Entidades.Persona", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PeliculasWebAPI.Entidades.SinLlaves.CineSinUbicacion", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PeliculasWebAPI.Entidades.SinLlaves.PeliculaConteos", b =>
                {
            ...
            modelBuilder.Entity("PeliculasWebAPI.Entidades.Mensaje", b =>
                {
                    b.HasOne("PeliculasWebAPI.Entidades.Persona", "Emisor")
                        .WithMany("MensajesEnviados")
                        .HasForeignKey("EmisorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PeliculasWebAPI.Entidades.Persona", "Receptor")
